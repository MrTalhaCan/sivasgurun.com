...
export const metadata = {
  title: "Sivasgurun.com - Atatürk Kongre Binası ve Müzesi",
  description: "Sivas Atatürk Kongre Binası ve Müzesi, 4-11 Eylül 1919 tarihleri arasında Sivas Kongresi'ne ev sahipliği yapmış, Türkiye Cumhuriyeti'nin temellerinin atıldığı önemli bir tarihî mekândır. 1892 yılında Mekteb-i Sultanî olarak inşa edilen bu yapı, Osmanlı mimarisinin geç dönem sivil mimari örneklerinden biridir. Günümüzde müze olarak hizmet veren bina, her yıl 4 Eylül'de düzenlenen Sivas Kongresi Anma Etkinlikleri'ne ev sahipliği yapmaktadır.",
};
export default async function AtaturkKongraBinasi(){
    const getPostData = async () => {
    try {
        const sql = `SELECT * FROM gezilecekyerler WHERE idgezilecekyerler=6`;
       ...
       <section className='mt-12 max-w-screen-lg w-full mx-auto'>    
            <article className='flex flex-col gap-8'>
                <figure>
                    ...
                    <figcaption className='text-center dark:text-textDark text-textLight'>Sivas Atatürk Kongre Binası ve Müzesi</figcaption>
                </figure>
