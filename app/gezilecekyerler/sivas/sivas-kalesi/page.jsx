...
export const metadata = {
  title: "Sivasgurun.com - Sivas Kalesi",
  description: "Tarihi Sivas Kalesi, şehrin eşsiz manzarası ve zengin tarihi dokusuyla ziyaretçilerini büyülüyor. Sivas'ın en önemli tarihi yapılarından biri olan kaleyi keşfedin ve geçmişe yolculuk yapın. Sivas Kalesi hakkında detaylı bilgi ve ziyaret ipuçları için sayfamızı ziyaret edin.",
};
export default async function SivasKalesi(){
    const getPostData = async () => {
    try {
        const sql = `SELECT * FROM gezilecekyerler WHERE idgezilecekyerler=4`;
    ...
    return(
       <section className='mt-12 max-w-screen-lg w-full mx-auto'>    
            <article className='flex flex-col gap-8'>
                <figure>
                    <Image className='m-auto rounded-lg shadow-lg shadow-slate-500 w-full' width={500} height={500} src={`/${reslt[0].content.mainImg}`} alt="sivas-kalesi" />
                    <figcaption className='text-center dark:text-textDark text-textLight'>Sivas Kalesi</figcaption>
                </figure>
                ...
                {/*<figure className="p-2">
                      <iframe src={reslt[0].content.position} width='600' height='450' title="Sivas Kalesi güzergah" className="max-w-screen-lg w-full mx-auto" allowfullscreen='' loading='lazy' referrerpolicy='no-referrer-when-downgrade'></iframe>
