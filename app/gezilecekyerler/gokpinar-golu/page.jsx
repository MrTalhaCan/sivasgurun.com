    ...
    const getValleyData = function(){
        return new Promise(function(resolve, reject){
			pool.getConnection((err, con) => {
				...
				var sql = `select * from gurunilan.gezilecekyerler WHERE idgezilecekyerler=1`;
				con.query(
					sql, 
					function(err, rows){                           
						if(rows === undefined){
    ...
    return(
       <section className='mt-12 max-w-screen-lg w-full mx-auto'>    
            <article className='flex flex-col gap-8'>
                <figure>
                    <img className='m-auto rounded-lg shadow-lg shadow-slate-500' src="/Gokpinar-Golu.jpg" alt="gokpınar" />
                    <figcaption className='text-center'>Gürün, Gökpınar Gölü</figcaption>
                </figure>
