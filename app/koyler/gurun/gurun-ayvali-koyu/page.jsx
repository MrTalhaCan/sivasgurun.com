...
export const metadata = {
  title: "Sivas Gürün - Ayvalı Köyü",
  description: "Gürün Ayvalı Köyü, altın sarısı ayva bahçeleri, geleneksel kerpiç evleri ve misafirperver köy yaşantısıyla Sivas'ın keşfedilmeyi bekleyen güzelliklerinden. Köyün tarihi çeşmesi, ahşap işçiliğiyle camisi ve leziz ayva tatlısı için detaylı gezi rehberi.",
};
export default async function AyvaliKoyu(){
const getPostData = async () => {
    try {
        const sql = `select * from yazilar WHERE idyazilar=15`;
