...
export const metadata = {
  title: "Sivas Gürün - Böğrüdelik Köyü",
  description: "Gürün Böğrüdelik Köyü, Sivas'ın tarih ve doğayla iç içe geçmiş şirin bir köşesi. Selçuklu ve Osmanlı döneminden kalma kültürel mirası, yemyeşil yaylaları ve el sanatlarıyla Anadolu'nun özünü yaşatan bir köy. Doğa yürüyüşleri, geleneksel köy yaşantısı ve misafirperverliğiyle unutulmaz bir kırsal deneyim sunuyor.",
};
export default async function BogrudelikKoyu(){
const getPostData = async () => {
    try {
        const sql = `select * from yazilar WHERE idyazilar=21`;
