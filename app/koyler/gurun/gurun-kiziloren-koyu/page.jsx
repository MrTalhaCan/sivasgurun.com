...
export const metadata = {
  title: "Sivas Gürün - Kızılören Köyü",
  description: "Tarihi dokusu ve üretken yapısıyla öne çıkan Kızılören Köyü, Gürün’ün doğal ve kültürel mirasını yansıtan önemli köylerinden biridir.",
};
export default async function KizilorenKoyu(){
const getPostData = async () => {
    try {
        const sql = `select * from yazilar WHERE idyazilar=54`;
