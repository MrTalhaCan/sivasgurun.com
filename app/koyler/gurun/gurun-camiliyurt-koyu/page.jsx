...
export const metadata = {
  title: "Sivas Gürün - Camiliyurt Köyü",
  description: "Gürün Camiliyurt Köyü, tarihi dokusu, doğal güzellikleri ve geleneksel köy yaşantısıyla dikkat çeken bir yerleşim yeridir. Tarım ve hayvancılıkla öne çıkan köy, doğa ile iç içe huzurlu bir ortam sunar. Ulaşımı kolay olan Camiliyurt, doğa yürüyüşleri ve kültürel keşifler için ideal bir destinasyondur.",
};
export default async function CamiliyurtKoyu(){
const getPostData = async () => {
    try {
        const sql = `select * from yazilar WHERE idyazilar=22`;
