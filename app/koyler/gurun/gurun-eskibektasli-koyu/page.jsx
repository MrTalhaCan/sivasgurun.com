...
export const metadata = {
  title: "Sivas Gürün - Eskibektaşlı Köyü",
  description: "Gürün ilçesine bağlı Eskibektaşlı Köyü, tarihi dokusu, doğal güzellikleri ve geleneksel yaşam tarzıyla dikkat çeken bir yerleşimdir. Tarım ve hayvancılığın yaygın olduğu köy, doğa severler için huzurlu bir ortam sunmaktadır.",
};
export default async function EskibektasliKoyu(){
const getPostData = async () => {
    try {
        const sql = `select * from yazilar WHERE idyazilar=32`;
