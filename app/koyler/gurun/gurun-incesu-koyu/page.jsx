...
export const metadata = {
  title: "Sivas Gürün - İncesu Köyü",
  description: "Sivas’ın Gürün ilçesine bağlı İncesu Köyü, doğal güzellikleri, verimli toprakları ve kültürel zenginliğiyle öne çıkan, geleneksel yaşamın sürdüğü huzurlu bir köydür.",
};
export default async function IncesuKoyu(){
const getPostData = async () => {
    try {
        const sql = `select * from yazilar WHERE idyazilar=40`;
