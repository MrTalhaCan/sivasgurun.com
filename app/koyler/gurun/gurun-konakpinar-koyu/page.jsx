...
export const metadata = {
  title: "Sivas Gürün - Konakpınar Köyü",
  description: "Doğal güzellikleri ve köy yaşamının sürdüğü yapısıyla öne çıkan Konakpınar Köyü, Gürün’ün sakin ve verimli yerleşim yerlerindendir.",
};
export default async function KonakpınarKoyu(){
const getPostData = async () => {
    try {
        const sql = `select * from yazilar WHERE idyazilar=56`;
