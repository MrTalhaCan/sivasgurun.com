...
export const metadata = {
  title: "Sivas Gürün - Deveçayırı Köyü",
  description: "Gürün Deveçayırı Köyü, Sivas'ın tarihi ve kültürel mirasını koruyan, doğayla iç içe bir yerleşim. Tarım ve hayvancılığın öne çıktığı köy, geleneksel yaşam tarzı ve doğa yürüyüşü rotalarıyla ziyaretçilerini ağırlıyor. Şehir yaşamından uzaklaşmak isteyenler için ideal bir köy.",
};
export default async function DevecayiriKoyu(){
const getPostData = async () => {
    try {
        const sql = `select * from yazilar WHERE idyazilar=29`;
