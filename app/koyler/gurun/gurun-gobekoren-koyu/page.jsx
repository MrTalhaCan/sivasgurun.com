...
export const metadata = {
  title: "Sivas Gürün - Göbekören Köyü",
  description: "Sivas’ın Gürün ilçesine bağlı Göbekören Köyü; doğal güzellikleri, tarımsal üretimi ve kültürel değerleriyle öne çıkan, geleneksel köy yaşantısını sürdüren sakin ve huzurlu bir yerleşim yeridir.",
};
export default async function GobekorenKoyu(){
const getPostData = async () => {
    try {
        const sql = `select * from yazilar WHERE idyazilar=34`;
