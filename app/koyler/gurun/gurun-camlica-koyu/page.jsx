...
export const metadata = {
  title: "Sivas Gürün - Çamlıca Köyü",
  description: "Gürün Çamlıca Köyü, tarihi yapıları, doğal güzellikleri ve huzurlu atmosferiyle dikkat çeken bir yerleşim alanıdır. Tarım ve hayvancılıkla öne çıkan köy, yemyeşil vadileri ve temiz havasıyla doğa severler için ideal bir destinasyondur. Kolay ulaşımı ve geleneksel kültürüyle keşfedilmeyi bekleyen bir doğa harikasıdır.",
};
export default async function CamlicaKoyu(){
const getPostData = async () => {
    try {
        const sql = `select * from yazilar WHERE idyazilar=23`;
