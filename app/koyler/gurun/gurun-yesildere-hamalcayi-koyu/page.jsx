...
export const metadata = {
  title: "Sivas Gürün - Yeşildere (Hamalçayı) Köyü",
  description: "Adını yeşil doğasından alan Yeşildere (Hamalçayı) Köyü, Gürün’ün doğal güzellikleri ve köy yaşantısını bir arada sunan huzurlu bir yerleşimidir.",
};
export default async function BaglicayKoyu(){
const getPostData = async () => {
    try {
        const sql = `select * from yazilar WHERE idyazilar=71`;
