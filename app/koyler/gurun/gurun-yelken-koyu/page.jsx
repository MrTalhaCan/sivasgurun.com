...
export const metadata = {
  title: "Sivas Gürün - Yelken Köyü",
  description: "Sivas Gürün Yelken Köyü, tarım ve hayvancılığa dayalı geçimi, sakin ortamı ve doğal güzellikleriyle öne çıkan bir yerleşimdir.",
};
export default async function YelkenKoyu(){
const getPostData = async () => {
    try {
        const sql = `select * from yazilar WHERE idyazilar=69`;
