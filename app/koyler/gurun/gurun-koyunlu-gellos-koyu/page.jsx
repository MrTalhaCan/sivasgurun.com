...
export const metadata = {
  title: "Sivas Gürün - Koyunlu (Gelloş) Köyü",
  description: "Gürün’ün Koyunlu (Gelloş) Köyü, tarım ve hayvancılık faaliyetleriyle geçimini sağlayan, geleneksel yaşam kültürünü koruyan köylerinden biridir.",
};
export default async function KoyunluKoyu(){
const getPostData = async () => {
    try {
        const sql = `select * from yazilar WHERE idyazilar=57`;
