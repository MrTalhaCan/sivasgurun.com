...
export const metadata = {
  title: "Sivas Gürün - Kürkçü Köyü",
  description: "Gürün Kürkçü Köyü; doğa ile iç içe yapısı, üretken tarım alanları ve köklü köy gelenekleriyle dikkat çeken yerleşimlerden biridir.",
};
export default async function KurkcuKoyu(){
const getPostData = async () => {
    try {
        const sql = `select * from yazilar WHERE idyazilar=59`;
