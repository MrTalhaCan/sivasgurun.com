...
export const metadata = {
  title: "Sivas Gürün - Davulhüyük Köyü",
  description: "Gürün Davulhüyük Köyü, Sivas'ın tarihi ve kültürel mirasını koruyan, doğal güzelliklerle çevrili bir yerleşim. Tarım ve hayvancılığın öne çıktığı köy, geleneksel taş evleri ve sakin atmosferiyle ziyaretçilerini ağırlıyor. Doğa yürüyüşleri ve kültürel keşif için ideal bir köy.",
};
export default async function DavulhuyukKoyu(){
const getPostData = async () => {
    try {
        const sql = `select * from yazilar WHERE idyazilar=27`;
