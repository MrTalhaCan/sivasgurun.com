...
export const metadata = {
  title: "Sivas Gürün - Dayakpınar Köyü",
  description: "Sivas’ın Gürün ilçesine bağlı Dayakpınar Köyü, doğal güzellikleri, tarım ve hayvancılıkla öne çıkan yapısı ve kültürel mirasıyla dikkat çekmektedir. Doğa yürüyüşü ve kampçılık için uygun olan köy, ulaşım açısından da rahattır.",
};
export default async function DayakpinarKoyu(){
const getPostData = async () => {
    try {
        const sql = `select * from yazilar WHERE idyazilar=28`;
