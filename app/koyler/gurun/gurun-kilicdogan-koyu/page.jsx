...
export const metadata = {
  title: "Sivas Gürün - Kılıçdoğan Köyü",
  description: "Gürün Kılıçdoğan Köyü, Sivas'ın tarihi dokusu ve doğal güzellikleriyle öne çıkan şirin bir köy. Geleneksel mimarisi, verimli toprakları ve huzurlu atmosferiyle keşfedilmeyi bekliyor.",
};
export default async function KilicdoganKoyu(){
const getPostData = async () => {
    try {
        const sql = `select * from yazilar WHERE idyazilar=51`;
