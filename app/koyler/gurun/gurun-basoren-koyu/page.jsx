...
export const metadata = {
  title: "Sivas Gürün - Başören Köyü",
  description: "Gürün Başören Köyü, Sivas'ın yüzyıllık tarihi ve eşsiz doğasıyla büyüleyen saklı bir cennet. Osmanlı döneminden günümüze uzanan geleneksel tarım kültürü, yemyeşil vadileri ve misafirperver köy yaşantısıyla Anadolu'nun özünü keşfetmek isteyenler için ideal bir rota. Doğa yürüyüşleri, geleneksel köy şenlikleri ve kartpostallık manzaralarıyla unutulmaz bir deneyim sunuyor.",
};
export default async function BasorenKoyu(){
const getPostData = async () => {
    try {
        const sql = `select * from yazilar WHERE idyazilar=19`;
