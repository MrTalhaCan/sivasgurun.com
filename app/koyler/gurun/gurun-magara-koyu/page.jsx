...
export const metadata = {
  title: "Sivas Gürün - Mağara Köyü",
  description: "Gürün Mağara Köyü, doğal oluşumları, geleneksel yaşam tarzı ve üretken yapısıyla dikkat çeken, huzurlu bir köy atmosferi sunar.",
};
export default async function MagaraKoyu(){
const getPostData = async () => {
    try {
        const sql = `select * from yazilar WHERE idyazilar=60`;
