...
export const metadata = {
  title: "Sivas Gürün - Kavakköyü Köyü",
  description: "Gürün Kavakköy, Sivas'ın doğal güzellikleriyle ünlü köylerinden biri. Kavak ağaçlarıyla çevrili yemyeşil manzaraları, geleneksel köy mimarisi ve misafirperver halkıyla ziyaretçilerini ağırlıyor. Doğa yürüyüşleri, köy kahvaltıları ve huzurlu bir tatil arayanlar için mükemmel bir seçenek.",
};
export default async function KavakkoyKoyu(){
const getPostData = async () => {
    try {
        const sql = `select * from yazilar WHERE idyazilar=48`;
