...
export const metadata = {
  title: "Sivas Gürün - Osmandede Köyü",
  description: "Tarihi dokusu ve doğal kaynaklarıyla dikkat çeken Osmandede Köyü, Gürün’ün kültürel mirasına katkı sağlayan köylerinden biridir.",
};
export default async function OsmandedeKoyu(){
const getPostData = async () => {
    try {
        const sql = `select * from yazilar WHERE idyazilar=62`;
