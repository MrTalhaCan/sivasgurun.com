...
export const metadata = {
  title: "Sivas Gürün - Erdoğan Köyü",
  description: "Gürün ilçesine bağlı Erdoğan Köyü, tarihi dokusu, doğal güzellikleri ve geleneksel yaşam tarzıyla dikkat çekmektedir. Verimli topraklarıyla tarım ve hayvancılığın yaygın olduğu köy, doğa ile iç içe huzurlu bir atmosfer sunmaktadır.",
};
export default async function ErdoganKoyu(){
const getPostData = async () => {
    try {
        const sql = `select * from yazilar WHERE idyazilar=31`;
