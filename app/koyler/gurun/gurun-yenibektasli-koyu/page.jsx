...
export const metadata = {
  title: "Sivas Gürün - Yenibektaşlı Köyü",
  description: "Modernleşen ama köklü geleneklerini koruyan Yenibektaşlı Köyü, Gürün’ün üretken ve kültürel olarak zengin köylerinden biridir.",
};
export default async function YenibektasliKoyu(){
const getPostData = async () => {
    try {
        const sql = `select * from yazilar WHERE idyazilar=70`;
