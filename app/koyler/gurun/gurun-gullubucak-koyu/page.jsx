...
export const metadata = {
  title: "Sivas Gürün - Güllübucak Köyü",
  description: "Sivas’ın Gürün ilçesine bağlı Güllübucak Köyü, doğal yapısı, tarım ve hayvancılıkla öne çıkan yaşamı ve kültürel değerleriyle dikkat çeken bir Anadolu köyüdür.",
};
export default async function GullubucakKoyu(){
const getPostData = async () => {
    try {
        const sql = `select * from yazilar WHERE idyazilar=37`;
