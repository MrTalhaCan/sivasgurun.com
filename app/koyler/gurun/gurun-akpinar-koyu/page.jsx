...
export const metadata = {
  title: "Sivas Gürün - Akpınar Köyü",
  description: "Gürün Akpınar Köyü, Sivas'ın tarih ve doğayla bütünleşen şirin bir yerleşimi. Zengin su kaynakları, verimli tarım arazileri ve antik dönemlerden kalma tarihi kalıntılarıyla keşfedilmeyi bekleyen bir hazine. Köyde organik tarım, geleneksel köy yaşantısı ve eşsiz doğa manzaraları sizi bekliyor. Tarihi İpek Yolu'nun izlerini taşıyan bu köyde Roma-Bizans mağaralarını gezebilir, yaylalarında huzur bulabilirsiniz.",
};
export default async function AkpinarKoyu(){
const getPostData = async () => {
    try {
        const sql = `select * from yazilar WHERE idyazilar=14`;
