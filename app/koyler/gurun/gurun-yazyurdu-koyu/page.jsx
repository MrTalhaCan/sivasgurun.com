...
export const metadata = {
  title: "Sivas Gürün - Yazyurdu Köyü",
  description: "Yazyurdu Köyü, Gürün’ün kırsal yaşamını yansıtan; doğal güzellikleri ve üretken yapısıyla dikkat çeken bir köydür.",
};
export default async function YazyurduKoyu(){
const getPostData = async () => {
    try {
        const sql = `select * from yazilar WHERE idyazilar=68`;
