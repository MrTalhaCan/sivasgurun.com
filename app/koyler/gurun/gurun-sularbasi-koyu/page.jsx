...
export const metadata = {
  title: "Sivas Gürün - Sularbaşı Köyü",
  description: "Adını çevresindeki su kaynaklarından alan Sularbaşı Köyü, Gürün’de doğal yaşamı ve üretkenliğiyle öne çıkan bir yerleşim yeridir.",
};
export default async function SularbasiKoyu(){
const getPostData = async () => {
    try {
        const sql = `select * from yazilar WHERE idyazilar=65`;
