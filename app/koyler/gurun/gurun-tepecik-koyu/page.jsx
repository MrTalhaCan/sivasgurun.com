...
export const metadata = {
  title: "Sivas Gürün - Tepecik Köyü",
  description: "Gürün Tepecik Köyü, Sivas’ın doğal güzellikleriyle çevrili, tarım ve hayvancılıkla geçimini sürdüren, huzurlu ve geleneksel yapısını koruyan şirin bir Anadolu köyüdür.",
};
export default async function TepecikKoyu(){
const getPostData = async () => {
    try {
        const sql = `select * from yazilar WHERE idyazilar=66`;
