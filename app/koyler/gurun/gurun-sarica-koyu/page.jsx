...
export const metadata = {
  title: "Sivas Gürün - Sarıca Köyü",
  description: "Sivas Gürün’de bulunan Sarıca Köyü; tarım, hayvancılık ve köklü gelenekleriyle yöresel yaşamın sürdüğü nadide köylerdendir.",
};
export default async function SaricaKoyu(){
const getPostData = async () => {
    try {
        const sql = `select * from yazilar WHERE idyazilar=64`;
