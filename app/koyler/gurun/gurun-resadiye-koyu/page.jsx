...
export const metadata = {
  title: "Sivas Gürün - Reşadiye Köyü",
  description: "Gürün Reşadiye Köyü, doğayla iç içe yapısı ve tarıma dayalı ekonomisiyle sakin ve üretken bir yaşam sunar.",
};
export default async function ResadiyeKoyu(){
const getPostData = async () => {
    try {
        const sql = `select * from yazilar WHERE idyazilar=63`;
