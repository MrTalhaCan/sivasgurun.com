...
export const metadata = {
  title: "Sivas Gürün - Dürmepınar Köyü",
  description: "Gürün Dürmepınar Köyü, Sivas'ın tarihi ticaret yolları üzerinde yer alan, geleneksel yaşamın sürdüğü bir Anadolu köyü. Verimli tarım arazileri, otantik taş mimarisi ve doğa yürüyüşü rotalarıyla ziyaretçilerini ağırlıyor. Şehir gürültüsünden uzak, huzurlu bir köy deneyimi için ideal.",
};
export default async function DurmepinarKoyu(){
const getPostData = async () => {
    try {
        const sql = `select * from yazilar WHERE idyazilar=30`;
