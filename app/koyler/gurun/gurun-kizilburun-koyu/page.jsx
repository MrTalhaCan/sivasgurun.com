...
export const metadata = {
  title: "Sivas Gürün - Kızılburun Köyü",
  description: "Gürün’ün doğal güzellikleriyle öne çıkan Kızılburun Köyü; tarım, hayvancılık ve geleneksel yaşam kültürüyle dikkat çeken huzurlu bir yerleşim yeridir. Keşfetmeye değer!",
};
export default async function KizilburunKoyu(){
const getPostData = async () => {
    try {
        const sql = `select * from yazilar WHERE idyazilar=53`;
