...
export const metadata = {
  title: "Sivas Gürün - Yolgeçen (tekirahma) Köyü",
  description: "Adı gibi tarihi geçiş yolları üzerinde yer alan Yolgeçen (Tekirahma) Köyü, Gürün’ün kültürel zenginliğini yansıtan kırsal bir yerleşimdir.",
};
export default async function YolgecenKoyu(){
const getPostData = async () => {
    try {
        const sql = `select * from yazilar WHERE idyazilar=72`;
