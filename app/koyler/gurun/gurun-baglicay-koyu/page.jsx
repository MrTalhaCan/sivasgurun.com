...
export const metadata = {
  title: "Sivas Gürün - Bağlıçay Köyü",
  description: "Gürün Bağlıçay Köyü, Sivas'ın tarih ve doğayla iç içe saklı cennetlerinden. Osmanlı döneminden kalma tarihi dokusu, verimli tarım arazileri ve misafirperver köy yaşantısıyla keşfedilmeyi bekleyen bir Anadolu köyü. Doğa yürüyüşleri için ideal dereleri, geleneksel köy düğünleri ve organik tarım ürünleriyle unutulmaz bir kırsal deneyim sizi bekliyor.",
};
export default async function BaglicayKoyu(){
const getPostData = async () => {
    try {
        const sql = `select * from yazilar WHERE idyazilar=16`;
