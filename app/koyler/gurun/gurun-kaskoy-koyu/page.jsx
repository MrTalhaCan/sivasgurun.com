...
export const metadata = {
  title: "Sivas Gürün - Kaşköy Köyü",
  description: "Gürün Kaşköy, Sivas'ın tarihi dokusu ve eşsiz doğal güzellikleriyle öne çıkan şirin bir köy. Geleneksel mimarisi, verimli toprakları ve huzur dolu atmosferiyle keşfedilmeyi bekliyor.",
};
export default async function KaskoyKoyu(){
const getPostData = async () => {
    try {
        const sql = `select * from yazilar WHERE idyazilar=47`;
