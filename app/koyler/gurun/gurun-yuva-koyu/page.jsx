...
export const metadata = {
  title: "Sivas Gürün - Yuva Köyü",
  description: "Gürün Yuva Köyü; doğayla uyumlu yaşamı, tarım ve hayvancılıkla iç içe düzeniyle sıcak bir köy atmosferi sunar.",
};
export default async function YuvaKoyu(){
const getPostData = async () => {
    try {
        const sql = `select * from yazilar WHERE idyazilar=73`;
