...
export const metadata = {
  title: "Sivas Gürün - Mahkenli Köyü",
  description: "Sivas’ın Gürün ilçesine bağlı Mahkenli Köyü, doğal yaşam alanları ve geleneksel üretim faaliyetleriyle öne çıkan bir yerleşim birimidir.",
};
export default async function BaglicayKoyu(){
const getPostData = async () => {
    try {
        const sql = `select * from yazilar WHERE idyazilar=61`;
