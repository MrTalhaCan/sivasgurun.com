...
export const metadata = {
  title: "Sivas Gürün - Akdere Köyü",
  description: "Gürün Akdere Köyü, Sivas'ın tarih ve doğayla iç içe saklı cennetlerinden. Roma-Bizans kalıntıları, geleneksel taş evleri ve berrak dereleriyle eşsiz bir deneyim sunuyor. Tarihi İpek Yolu güzergahındaki köyde organik tarım, yayla turizmi ve otantik köy yaşantısını keşfedin. Doğa yürüyüşleri, tarihi mağaralar ve geleneksel köy düğünleriyle unutulmaz bir Anadolu deneyimi için ziyaret edin.",
};
export default async function AkdereKoyu(){
const getPostData = async () => {
    try {
        const sql = `select * from yazilar WHERE idyazilar=13`;
