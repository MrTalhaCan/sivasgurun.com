...
export const metadata = {
  title: "Sivas Gürün - Külahlı Köyü",
  description: "Sakin atmosferi, kültürel değerleri ve doğal güzellikleriyle bilinen Külahlı Köyü, Gürün’ün özgün ve yaşam dolu köylerinden biridir.",
};
export default async function KulahliKoyu(){
const getPostData = async () => {
    try {
        const sql = `select * from yazilar WHERE idyazilar=58`;
