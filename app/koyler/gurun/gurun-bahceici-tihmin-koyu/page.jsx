...
export const metadata = {
  title: "Sivas Gürün - Bahçeiçi (tıhmın) Köyü",
  description: "Gürün Bahçeiçi (tıhmın) Köyü, Sivas'ın organik tarım ve geleneksel yaşamın harmanlandığı şirin bir köşesi. Osmanlı'dan günümüze uzanan tarihi dokusu, verimli tarım arazileri ve misafirperver köy halkıyla keşfedilmeyi bekleyen bir Anadolu hazinesi. Doğa yürüyüşleri için ideal yeşil alanları ve otantik köy düğünleriyle unutulmaz bir kırsal deneyim sunuyor."
};
export default async function BahceiciKoyu(){
const getPostData = async () => {
    try {
        const sql = `select * from yazilar WHERE idyazilar=18`
