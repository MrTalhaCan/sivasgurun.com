...
export const metadata = {
  title: "Sivas Gürün - Yılanhüyük Köyü",
  description: "Yılanhüyük Köyü, doğal dokusu ve kırsal yaşam biçimiyle Gürün’de öne çıkan köylerden biridir. Geleneksel yapısı korunmaktadır.",
};
export default async function YilanhuyukKoyu(){
const getPostData = async () => {
    try {
        const sql = `select * from yazilar WHERE idyazilar=74`;
