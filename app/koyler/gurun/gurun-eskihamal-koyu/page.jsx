...
export const metadata = {
  title: "Sivas Gürün - Eskihamal Köyü",
  description: "Gürün ilçesine bağlı Eskihamal Köyü, tarihi dokusu, doğal güzellikleri ve geleneksel yaşam tarzıyla öne çıkan huzurlu bir yerleşimdir. Tarım ve hayvancılığın yaygın olduğu köy, doğayla iç içe bir deneyim sunmaktadır.",
};
export default async function EskihamalKoyu(){
const getPostData = async () => {
    try {
        const sql = `select * from yazilar WHERE idyazilar=33`;
