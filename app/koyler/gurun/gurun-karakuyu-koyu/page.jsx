...
export const metadata = {
  title: "Sivas Gürün - Karakuyu Köyü",
  description: "Gürün Karakuyu Köyü, Sivas'ın doğa harikası köylerinden biri. Tarihi dokusu, verimli toprakları ve sakin yaşamıyla dikkat çeken köy, doğa yürüyüşleri ve köy turizmi için ideal. Geleneksel mimarisi ve misafirperver halkıyla unutulmaz bir köy deneyimi sunuyor.",
};
export default async function KarakuyuKoyu(){
const getPostData = async () => {
    try {
        const sql = `select * from yazilar WHERE idyazilar=44`;
