...
export const metadata = {
  title: "Sivas Gürün - Karadoruk Köyü",
  description: "Sivas’ın Gürün ilçesine bağlı Karadoruk Köyü, doğal yapısı, tarıma elverişli toprakları ve köklü kültürel mirasıyla geleneksel köy yaşamını yansıtan huzurlu bir yerleşim yeridir."
};
export default async function KaradorukKoyu(){
const getPostData = async () => {
    try {
        const sql = `select * from yazilar WHERE idyazilar=42`;
