...
export const metadata = {
  title: "Sivas Gürün - Güldede Köyü",
  description: "Sivas’ın Gürün ilçesine bağlı Güldede Köyü, geleneksel yaşamı, tarıma elverişli yapısı ve doğal güzellikleriyle dikkat çeken huzurlu bir yerleşim yeridir.",
};
export default async function GuldedeKoyu(){
const getPostData = async () => {
    try {
        const sql = `select * from yazilar WHERE idyazilar=36`;
