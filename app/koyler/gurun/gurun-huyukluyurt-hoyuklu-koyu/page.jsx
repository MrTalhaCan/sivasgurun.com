...
export const metadata = {
  title: "Sivas Gürün - Hüyüklüyurt (Höyüklü) Köyü",
  description: "Sivas’ın Gürün ilçesine bağlı Hüyüklüyurt (Höyüklü) Köyü, tarihi dokusu, doğal yapısı ve geleneksel köy yaşamı ile dikkat çeken, tarım ve hayvancılığın sürdüğü sakin bir yerleşim yeridir.",
};
export default async function HuyukluyurtKoyu(){
const getPostData = async () => {
    try {
        const sql = `select * from yazilar WHERE idyazilar=39`;
