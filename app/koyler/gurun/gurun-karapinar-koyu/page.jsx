...
export const metadata = {
  title: "Sivas Gürün - Karapınar Köyü",
  description: "Gürün Karapınar Köyü, Sivas'ın doğa harikası köylerinden biri. Tarihi çeşmeleri, geleneksel taş evleri ve bereketli topraklarıyla dikkat çeken köy, doğa yürüyüşleri ve köy turizmi için ideal. Organik tarım ürünleri ve misafirperver halkıyla unutulmaz bir köy deneyimi sunuyor.",
};
export default async function KarapinarKoyu(){
const getPostData = async () => {
    try {
        const sql = `select * from yazilar WHERE idyazilar=46`;
