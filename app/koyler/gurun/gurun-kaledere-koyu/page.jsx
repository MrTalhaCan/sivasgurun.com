...
export const metadata = {
  title: "Sivas Gürün - Kaledere Köyü",
  description: "Sivas’ın Gürün ilçesine bağlı Kaledere Köyü, tarihi dokusu, doğal güzellikleri ve tarım-hayvancılıkla şekillenen geleneksel yaşam tarzıyla dikkat çeken sakin bir yerleşim yeridir.",
};
export default async function KaledereKoyu(){
const getPostData = async () => {
    try {
        const sql = `select * from yazilar WHERE idyazilar=41`;
