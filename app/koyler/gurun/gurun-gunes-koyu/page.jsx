...
export const metadata = {
  title: "Sivas Gürün - Güneş Köyü",
  description: "Sivas’ın Gürün ilçesine bağlı Güneş Köyü, doğal güzellikleri, tarım ve hayvancılıkla iç içe yaşamı ve geleneksel köy kültürüyle öne çıkan huzurlu bir yerleşim yeridir.",
};
export default async function GunesKoyu(){
const getPostData = async () => {
    try {
        const sql = `select * from yazilar WHERE idyazilar=38`;
