...
export const metadata = {
  title: "Sivas Gürün - Karahisar Köyü",
  description: "Gürün Karahisar Köyü, Sivas'ın tarihi kaleleri ve doğal güzellikleriyle ünlü şirin bir köyü. Geleneksel mimarisi, verimli toprakları ve eşsiz manzaralarıyla keşfedilmeyi bekliyor.",
};
export default async function KarahisarKoyu(){
const getPostData = async () => {
    try {
        const sql = `select * from yazilar WHERE idyazilar=43`;
