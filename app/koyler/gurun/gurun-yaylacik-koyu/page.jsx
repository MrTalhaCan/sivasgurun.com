...
export const metadata = {
  title: "Sivas Gürün - Yaylacık Köyü",
  description: "Yayla kültürünü yaşatan Yaylacık Köyü, Gürün’ün doğal zenginlikleri ve geleneksel üretim anlayışıyla öne çıkar.",
};
export default async function YaylacikKoyu(){
const getPostData = async () => {
    try {
        const sql = `select * from yazilar WHERE idyazilar=67`;
