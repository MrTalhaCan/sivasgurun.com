...
export const metadata = {
  title: "Sivas Gürün - Beypınarı Köyü",
  description: "Sivas'ın Gürün ilçesindeki Beypınarı Köyü, tarihi dokusu ve doğal güzellikleriyle öne çıkıyor. Tarım ve hayvancılığın yaşatıldığı köyde geleneksel yaşam devam ediyor. Doğa yürüyüşleri, yöresel kültür ve huzurlu bir tatil arayanlar için ideal bir destinasyon.",
};
export default async function BeypinariKoyu(){
const getPostData = async () => {
    try {
        const sql = `select * from yazilar WHERE idyazilar=25`;
