...
export const metadata = {
  title: "Sivas Gürün - Kaynarca Köyü",
  description: "Gürün Kaynarca Köyü, Sivas'ın şifalı suları ve yemyeşil doğasıyla ünlü köyü. Kaplıcaları, tarihi dokusu ve huzurlu atmosferiyle keşfedilmeyi bekliyor.",
};
export default async function KaynarcaKoyu(){
const getPostData = async () => {
    try {
        const sql = `select * from yazilar WHERE idyazilar=50`;
