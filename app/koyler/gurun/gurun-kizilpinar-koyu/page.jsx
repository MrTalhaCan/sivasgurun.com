...
export const metadata = {
  title: "Sivas Gürün - Kızılpınar Köyü",
  description: "Kızılpınar Köyü; doğal su kaynakları, tarıma dayalı yaşamı ve geleneksel köy kültürüyle Gürün’ün özgün köylerinden biridir.",
};
export default async function KizilpinarKoyu(){
const getPostData = async () => {
    try {
        const sql = `select * from yazilar WHERE idyazilar=55`;
