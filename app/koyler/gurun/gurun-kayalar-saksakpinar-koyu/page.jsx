...
export const metadata = {
  title: "Sivas Gürün - Kayalar (Şakşakpınar) Köyü",
  description: "Gürün Kayalar (Şakşakpınar) Köyü, Sivas'ın doğa harikası köylerinden biri. Benzersiz kaya formasyonları, tarihi evleri ve yemyeşil manzaralarıyla ziyaretçilerini büyülüyor. Doğa yürüyüşleri, kaya tırmanışı ve fotoğrafçılık için ideal olan köy, geleneksel yaşamı deneyimlemek isteyenler için mükemmel bir seçenek.",
};
export default async function KayalarKoyu(){
const getPostData = async () => {
    try {
        const sql = `select * from yazilar WHERE idyazilar=49`;
