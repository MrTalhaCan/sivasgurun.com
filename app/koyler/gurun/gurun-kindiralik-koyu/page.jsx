...
export const metadata = {
  title: "Sivas Gürün - Kındıralık Köyü",
  description: "Gürün Kındıralık Köyü, Sivas'ın yemyeşil doğası ve geleneksel yaşamıyla öne çıkan şirin bir köy. Tarihi dokusu, organik tarımı ve huzurlu atmosferiyle keşfedilmeyi bekliyor.",
};
export default async function KindiralikKoyu(){
const getPostData = async () => {
    try {
        const sql = `select * from yazilar WHERE idyazilar=52`;
