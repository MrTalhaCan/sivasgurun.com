...
export const metadata = {
  title: "Sivas Gürün - Karaören Köyü",
  description: "Gürün Karaören Köyü, Sivas'ın tarihi ve kültürel mirasını koruyan otantik bir Anadolu köyü. Tarihi evleri, bereketli tarım arazileri ve doğal güzellikleriyle ziyaretçilerini büyülüyor. Doğa yürüyüşleri, köy turizmi ve sakin bir tatil arayanlar için ideal bir destinasyon.",
};
export default async function KaraorenKoyu(){
const getPostData = async () => {
    try {
        const sql = `select * from yazilar WHERE idyazilar=45`;
