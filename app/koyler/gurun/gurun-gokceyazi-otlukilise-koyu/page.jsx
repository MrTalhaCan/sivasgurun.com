...
export const metadata = {
  title: "Sivas Gürün - Gökçeyazı (Otlukilise) Köyü",
  description: "Sivas’ın Gürün ilçesine bağlı Gökçeyazı (Otlukilise) Köyü, tarihi dokusu, verimli toprakları ve doğal güzellikleriyle dikkat çeken; tarım ve hayvancılıkla öne çıkan sakin bir Anadolu köyüdür.",
};
export default async function GokceyaziKoyu(){
const getPostData = async () => {
    try {
        const sql = `select * from yazilar WHERE idyazilar=35`;
