...
export const metadata = {
  title: "Sivas Gürün - Bozhüyük Köyü",
  description: "Gürün Bozhüyük Köyü, Sivas'ın tarihi ve doğal güzellikleriyle öne çıkan şirin bir yerleşim. Tarihi dokusu, geleneksel tarım ve hayvancılık kültürüyle ziyaretçilerine huzurlu bir kaçamak sunuyor. Doğa yürüyüşleri, kültürel miras ve sıcak köy yaşamı için Bozhüyük Köyü'nü keşfedin!",
};
export default async function BozhuyukKoyu(){
const getPostData = async () => {
    try {
        const sql = `select * from yazilar WHERE idyazilar=20`;
