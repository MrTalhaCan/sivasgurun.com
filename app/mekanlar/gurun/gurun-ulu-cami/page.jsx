...
export const metadata = {
  title: "Sivasgurun.com - Gürün Ulu Cami",
  description: "Gürün Ulu Cami, Sivas'ın Gürün ilçesinde yer alan tarihi ve mimari bir şaheser. Osmanlı dönemine ait bu cami, ahşap işçiliği ve sade mimarisiyle dikkat çekiyor. Gürün'ün dini ve kültürel mirasını yansıtan Ulu Cami, ziyaretçilere huzur dolu bir atmosfer sunuyor. Gürün Ulu Cami hakkında detaylı bilgi ve ziyaret ipuçları için sayfamızı ziyaret edin.",
};
export default async function UluCami(){
const getPostData = async () => {
    try {
        const sql = `select * from yazilar WHERE idyazilar=1`;
	...
	className='m-auto rounded-lg shadow-lg shadow-slate-500'
        ...
        alt="gurun-ulu-cami"
      />
                    <figcaption className='text-center dark:text-textDark text-textLight'>Gürün, Ulu Cami</figcaption>
                </figure>
