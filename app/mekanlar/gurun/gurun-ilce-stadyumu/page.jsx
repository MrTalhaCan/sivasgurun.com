...
export const metadata = {
  title: "Sivasgurun.com - Gürün İlçe Stadyumu",
  description: "Gürün İlçe Stadyumu, Sivas'ın Gürün ilçesinde spor tutkunları için modern bir tesis. Futbol maçları ve çeşitli spor etkinliklerine ev sahipliği yapan stadyum, bölgenin sosyal ve sportif hayatına katkıda bulunuyor. Gürün'de sporun kalbinin attığı bu tesis, hem yerel halk hem de ziyaretçiler için keyifli bir deneyim sunuyor.",
};
export default async function Stadyum(){
const getPostData = async () => {
    try {
        const sql = `select * from yazilar WHERE idyazilar=8`;
	...
	className='m-auto rounded-lg shadow-lg shadow-slate-500'
        ...
        width={500}
        height={500}
        alt="gurun-ilçe-stadyumu"
      />
                    <figcaption className='text-center dark:text-textDark text-textLight'>Gürün İlçe Stadyumu</figcaption>
                </figure>
