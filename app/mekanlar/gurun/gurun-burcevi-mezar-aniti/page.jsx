...
export const metadata = {
  title: "Sivasgurun.com - Gürün Burçevi Mezar Anıtı",
  description: "Gürün Burçevi Mezar Anıtı, Sivas'ın Gürün ilçesinde bulunan tarihi ve kültürel bir miras. Antik dönemlere ait bu mezar anıtı, bölgenin zengin tarihine ışık tutuyor. Taş işçiliği ve mimarisiyle dikkat çeken anıt, ziyaretçilere geçmişe dair eşsiz bir keşif imkanı sunuyor. Gürün Burçevi Mezar Anıtı hakkında detaylı bilgi ve ziyaret ipuçları için sayfamızı ziyaret edin.",
};
export default async function BurcEvi(){
const getPostData = async () => {
    try {
        const sql = `select * from yazilar WHERE idyazilar=7`;
	...
	className='m-auto rounded-lg shadow-lg shadow-slate-500'
        ...
        width={500}
        height={500}
        alt="gurun-burcevi-mezar-aniti"
      />
                    <figcaption className='text-center dark:text-textDark text-textLight'>Gürün Burçevi Mezar Anıtı</figcaption>
                </figure>
